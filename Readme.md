...
> 欢迎加入Discord交流：请点击[这里](https://discord.gg/S2XCT6Uu)加入，以便获取更多的更新支持，或者问题反馈，注意，不提供搭建教程。
> 
> Welecome to join Discord：Click [Discord Group](https://discord.gg/S2XCT6Uu) to join inorder to get support.
